        ...
        <section class="hero-section">
            <div class="section-content">
                <div class="hero-details">
                    ...
                    <h3 class="subtitle">Make your day great with our special 
                        coffee!</h3>
                        <p class="description">Welcome to oue coffee paradise,where
                        every been tells a story and every cup sparks joy.</p>
            ...
            <div class="section-content">
                ...
                <div class="about-details">
                    ...
                    <p class="text">At Coffee House in Berndorf, Germany, we pride
                         ourselves on being a go-to destination for coffee lovers 
                         and conversations seekers alike. We're dedicated to providing an 
            ...
            <div class="section-content">
                <ul class="menu-list">
                    <li class="menu-item">
                        ...
                        <p class="text">Wide range of Steaming hot coffee to make your 
                            fresh and light.</p>
                  </div>
                    </li>
                    <li class="menu-item">
                        ...
                        <p class="text">Creams and frothy cold coffee to make you
                            cool.</p>
                    </div>
                    </li>
                    <li class="menu-item">
                        ...
                        <p class="text">Fruits and icy refreshing drink to make feel
                             refreshing</p>
                    </div>
                    </li>
                    <li class="menu-item">
                    ...
                    <li class="menu-item">
                        ...
                        <p class="text">Satiate your palate and take you on a 
                            culinary treat. </p>
                    </div>
                    </li>
                    <li class="menu-item">
                        ...
                        <p class="text">Quick bites to satisfy your small size
                            hunger. </p>
                    </div>
                </li>   
                </ul>
                        ...
                        <ul class="testimonials-list swiper-wrapper">
                            <li class="testimonial swiper-slide">
                                ...
                                <i class="feedback">"Loved the French roast.Perfectly
                                    balanced and rich.Will order again!"</i>
                            </li>
                            <li class="testimonial swiper-slide">
                                ...
                                <i class="feedback">"Great espresso blend Smooth and bold
                                    flavor. Fast shipping tool!"</i>
                            </li>
                            <li class="testimonial swiper-slide">
                                <img src="images/user-3.jpg" alt="User" class="user-image">
                                <h3 class="name">Michael Brown</h3>
                                <i class="feedback">"Fantastic mocha flavour. Fresh and 
                                    aromatic. Quick shipping!"</i>
                            </li>
                            <li class="testimonial swiper-slide">
                                ...
                                <i class="feedback">"Excellent quality! Fresh beans and 
                                    quick delivery. Highly recommind."</i>
                            </li>
                            <li class="testimonial swiper-slide">
            ...
            <div class="section-content">
                <ul class="contact-into-list">
                    <li class="contact-info">
                        ...
                        <p>sector 27 near by Mhasakant Chowk</p>
                    </li>
                    <li class="contact-info">
